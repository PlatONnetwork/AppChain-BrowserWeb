...
export default {
  ...
  nodeInfo: {
    ...
    node1Tips: '节点在最近4个结算周期每份额质押净收益折合成的年化收益率，仅做参考。',
    node2Tips: '委托者最近4个结算周期每份额委托净收益折合成的年化收益率，仅做参考。',
  ...
  more: {
    ...
    createValidateNode: '创建验证节点',
    removeValidateNode: '退出验证节点',
    ...
    unDelegateFreezeDuration: '解除委托后，委托金冻结的结算周期数（一个结算周期10750blocks）',
  ...
  validateNode: {
    ...
    stakingAmount: '质押金额',
    acceptDelegate: '是否接收委托',
    emptyNodeName: '节点名称不能为空',
    invalidNodeName: '请输入格式正确且有效的节点名称',
    emptyNodeLogo: '节点Logo不能为空',
    invalidNodeID: '请输入格式正确且有效的节点ID',
    emptyNodeID: '节点ID不能为空',
    invalidBLSPubKey: '请输入格式正确且有效的BLS公钥',
    emptyBLSPubKey: 'BLS公钥不能为空',
    invalidAddress: '请输入格式正确的钱包地址',
    emptyRelayAccount: '节点中继账户地址不能为空',
    emptyEquityAccount: '节点权益地址不能为空',
    emptyStakingAmount: '质押金额不能为空',
    lessStakingAmount: '质押金额不能低于',
    notExistNodeID: '未查询到该节点ID数据',
    inputTips: {
      nodeName: '不超过30字节，必须字母开头，支持字母数字上下划线及#',
      nodeLogo: '输入Keybase.io的64-bit Publickey获取账号头像',
      nodeID: '128个字符的节点公钥',
      blsPubKey: '192个字符的节点BLS公钥',
