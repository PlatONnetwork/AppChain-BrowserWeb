...
export default {
  ...
  footer: {
    desc: 'AppChainScan is a Block Explorer and Analytics Platform for AppChain',
    links: 'Links',
    help: 'Help',
    wallet: 'Wallet',
    officialWebsite: 'AppChain Official Website',
  ...
  tradeAbout: {
    ...
    removeValidator: 'Exit the Validator',
  ...
  contract: {
    ...
    unclaimedDelegateTips:
      'The amount of delegations beyond the freezing period that can be withdrawn and directly deposited into the account',
  ...
  indexInfo: {
    ...
    resource: 'RESOURCE',
    aboutPlatON: 'About AppChain',
    platONWhitePaper: 'AppChain White Paper',
  ...
  validateNode: {
    ...
    acceptDelegate: 'Accept delegation',
    emptyNodeName: 'Node Name cannot be empty',
    invalidNodeName: 'Please enter a correctly formatted and valid node name',
    emptyNodeLogo: 'Node Logo cannot be empty',
    invalidNodeID: 'Please enter a correctly formatted and valid node ID',
    emptyNodeID: 'Node ID cannot be empty',
    invalidBLSPubKey: 'Please enter a correctly formatted and valid BLS public key',
    emptyBLSPubKey: 'BLS public key cannot be empty',
    invalidAddress: 'Please enter a correctly formatted wallet address',
    emptyRelayAccount: 'Node relay account address cannot be empty',
    emptyEquityAccount: 'Node equity accounts address cannot be empty',
    emptyStakingAmount: 'Staking amount cannot be empty',
    lessStakingAmount: 'Staking amount cannot be less than',
    notExistNodeID: 'No data found for this node ID',
    inputTips: {
      nodeName: 'No more than 30 bytes, must start with letters, support letters, numbers, underscores and #',
      nodeLogo: 'Enter the 64-bit Publickey of Keybase.io to get the account avatar',
      nodeID: '128 character node public key',
      blsPubKey: '192 character node BLS public key',
    ...
    processSucc: 'Process Successfully',
    processFailed: 'Process Failed',
    connectWallet: 'Connect Wallet',
    connectEquityAccount: 'Connect Equity Account',
