    ...
    <div class="information box-relative" v-loading="loading">
      ...
      >
        ...
        <Item
          ...
          v-if="detailInfo.txType != '4000'"
          >{{ detailInfo.value | formatMoney }} </Item
        >
        <!-- 锁仓 -->
        <template v-if="detailInfo.txType == '4000'">
          ...
          <Item :label="$t('tradeAbout.restrictedAmount')">
            <span>{{ detailInfo.rpnum | formatMoney }} </span>
          </Item>
        ...
        <Item :label="$t('tradeAbout.transactionFee')">
          <span>{{ detailInfo.actualTxCost | formatMoney }} </span>
        </Item>
      </List>
        ...
        >
          <ul>
            ...
            >
              ...
              >
              for
              <span class="money">{{ item.value | fromWei(18) | formatMoney }} </span>
            </li>
          </ul>
        </Item>
        <!-- erc20 tokens -->
      ...
      >
        ...
        >
          ...
          <span>{{ detailInfo.txAmount | formatMoney }} </span>
        </Item>
        <!-- 赎回数量 -->
        <Item
        ...
        >
          <!-- :prop="detailInfo.value + ''" -->
          <span>{{ detailInfo.applyAmount | formatMoney }} </span>
          <!-- <span>({{$t('tradeAbout.undelegat')}}:{{detailInfo.actualTxCost}} /{{$t('tradeAbout.successed')}})</span> -->
          <!-- 赎回失敗 -->
          ...
          <template v-else>
            ...
            >({{$t('tradeAbout.remain1')}}:{{detailInfo.redeemLocked | formatMoney}} )</span> -->
            <!-- 1： 赎回中 -->
            <!-- <span
      ...
      >
        ...
        <Item :label="$t('tradeAbout.extractDelegateAmount')">
          <span>{{ detailInfo.redeemDelegationValue | formatMoney }} </span>
        </Item>
        <!-- 交易手续费 -->
        <Item :label="$t('tradeAbout.transactionFee')">
          <!-- :prop="detailInfo.actualTxCost + ''" -->
      ...
      >
        ...
        <template v-if="detailInfo.txType == '3000'">
          ...
          <Item :label="$t('tradeAbout.reportReward')">
            ...
            <span>{{ detailInfo.reportRewards | formatMoney }} </span>
          </Item>
        </template>
        <!-- 操作地址（举报验证人没有） -->
        <Item
        ...
        <template v-if="detailInfo.txType == '1003'">
          ...
          <Item :label="$t('tradeAbout.returnAmount')">
            ...
            <span>{{ detailInfo.applyAmount | formatMoney }} </span>
            <!-- <span>:{{detailInfo.formatMoney}} /</span> -->
            <!-- 1： 退回中 -->
      ...
      >
        ...
        <Item :label="$t('tradeAbout.gasPrice')"
          >{{ detailInfo.gasPrice | formatMoney }} </Item
        >
        <!-- 交易数据 -->
        <Item
          class="extra-data"
