      ...
      <div class="node-list-header">
        <List class="statistic-info">
          ...
          <Item :label="$t('nodeInfo.totalDelegations')">
            <!-- <p>{{(ValidatorStatisticData.stakingDelegationValue-ValidatorStatisticData.stakingValue) | formatMoney}}<span class="fontSize13">HSK</span></p> -->
            <p>
              ...
              <span class="fontSize13 currency">&nbsp;HSK</span>
            </p>
          </Item>
        ...
        <List class="statistic-info">
          ...
          <Item :label="$t('blockAbout.blockReward')">
            ...
            <span class="fontSize13">HSK</span>
          </p>-->
            <p>
              <span class="Gilroy-Medium">{{
